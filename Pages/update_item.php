            ...
            <div class="modal md" id="modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action = "update_item_db.php?id=<?php echo $data['Image'];?>" method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <label for="product_d"><i class="fab fa-glide-g fa-2x"></i>Product Id</label>
                                <input type="text" name="product_id" class="form-control" value="<?php echo $data['Product_Id'];?>"required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="name"><i class="fas fa-rupee-sign fa-2x"></i>Price</label>
                            ...
                            <div class="form-group">
                                ...
                                <img src="Item/<?php echo $data['Image'];?>" weight="150px" height="150px">
                                <input type="file" name="img" class="form-control">
                            </div>
                    
                            <div class="modal-footer justify-content-center">
                                <!-- <button class="btn btn-danger" data-dismiss="modal">Log in</button> -->
                                <input type="submit" value="Update Item"  name="submit" class="btn btn-success alert">
                            </div>
                        </form>
                    </div>
                </div>
